...
class Scan extends React.Component {
    ...
    processClaimReturned(checkinResp) {
        console.log('UIU-1219: ' + JSON.stringify(checkinResp));

        const fetchLoan = () => {
            const { mutator } = this.props;
            console.log('loanId: ' + JSON.stringify(checkinResp.loan.id));
            this.props.mutator.loanId.replace(checkinResp.loan.id);
            // return mutator.loan.GET();
        ...
        const processAccounts = async () => {
            ...
            console.log('processAccounts-loans: ' + JSON.stringify(loans));
            console.log('processAccounts-accounts: ' + JSON.stringify(accounts));
            const lostItemFeePolicies = await getLostItemPolicy(loans.lostItemPolicyId);
            ...
            console.log('processAccounts-filterAccounts: ' + JSON.stringify(filterAccounts));
